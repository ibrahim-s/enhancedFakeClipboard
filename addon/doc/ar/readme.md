...
*	لقد تَمَّ تحديث الترجمة الروسية, بواسطة [Kostenkov-2021](https://github.com/Kostenkov-2021).

### التغييرات في 2.2.7 ###

*	لقد تَمَّ تحديث آخر إصدار تم اختباره، وبالتالي جعل الإضافة متوافقة مع إصدار NVDA 2026.1.
