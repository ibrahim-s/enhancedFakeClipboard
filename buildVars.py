...
addon_info = {
	...
	"addon_name": "enhancedFakeClipboard",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary": _("Enhanced Fake Clipboard"),
	# Add-on description
...
mainly for copy, cut, paste and select all actions."""),
	...
	"addon_url": "https://github.com/ibrahim-s/enhancedFakeClipboard",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/ibrahim-s/enhancedFakeClipboard",
